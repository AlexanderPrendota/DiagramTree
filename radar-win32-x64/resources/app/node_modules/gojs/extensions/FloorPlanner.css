...
#myPaletteDiv {width: 100%; height: 300px; background: #e2e2e2;}
#myPalette2Div {width: 100%; height: 150px; background: #e2e2e2;}
...
#paletteIdentifierDiv {
	z-index: 2; /*Places this element over overhanging nodes in the palette*/
	position: inherit;
	bottom: -38px;
	width: 100%;
...
.dockedWindows {
	height: 75vh; z-index: 10; position: absolute;
}

#leftDockedWindows {float: left;}
#rightDockedWindows {float: right;}
...
#wallWidthInput, #gridSizeInput {
	width: 50px; 
	float: left;
	border-right: 0px;
}
#gridSizeInput { margin-left: 10%; }
	#wallWidthUnitsInput, #gridSizeUnitsInput{float: left;}

#wallWidthInputLabel{ float: left; }
