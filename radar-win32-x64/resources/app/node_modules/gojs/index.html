...
<body id="frontpage">
    ...
    <div class="container-fluid plr15">
      ...
      <!--<div class="row text-center bg-success">
        <h3>This is GoJS 1.7 Beta.  See the <a href="doc/changelog.html">changes here</a></h3>
      </div>-->
      <div class="row text-center bg-success">
        <h3>NEW! GoJS version 1.7: read about the <a href="doc/changelog.html">new features and changes here</a></h3>
      </div>
